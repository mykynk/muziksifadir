...
class BloglarMasaustu extends StatefulWidget {
  BloglarMasaustu({Key key}) : super(key: key);

  @override
  _BloglarMasaustuState createState() => _BloglarMasaustuState();
}

class _BloglarMasaustuState extends State<BloglarMasaustu> {
                      ...
                      ? Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              BloglarMasaustuModel oAnkiEleman = snapshot.data[0];
                              return Container(
